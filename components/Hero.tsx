          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 w-full min-w-[300px] sm:min-w-0">
            {TABS.map((tab) => (
              <button
                ...
                className={`pb-4 text-[13px] sm:text-[15px] font-semibold transition-all relative border-r border-slate-200 dark:border-gray-800 last:border-r-0 bg-white dark:bg-[#13141b] z-10 px-2 sm:px-0 ${activeTab === tab ? "text-[#1c1c1c] dark:text-white" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
                  }`}
              >
                {tab}
                {activeTab === tab && (
