...
export default function MaturityAssessmentSection() {
  return (
    <section className="relative py-20 lg:py-32 bg-white dark:bg-[#13141b] flex flex-col items-center overflow-hidden transition-colors duration-200">
      ...
      <div className="container px-4 mx-auto max-w-[1200px] relative z-10">
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#1c1c1c] dark:text-white mb-6 px-4">
            Assess the Maturity of your Team
          </h2>
          
          <p className="text-base sm:text-lg text-slate-600 dark:text-gray-300 mb-2 max-w-2xl mx-auto px-4">
            Find out in 3 minutes. Get insights that drive real performance.
          </p>
          
          <p className="text-sm sm:text-base text-slate-500 dark:text-gray-400 mb-8 max-w-2xl mx-auto px-4">
            Built by expert coaches, powered by 20 years of field experience
          </p>
