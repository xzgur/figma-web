        ...
        <div className="container max-w-[1440px] mx-auto px-6 flex items-center justify-between relative">
            ...
            <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center gap-1" ref={navRef}>
                {navLinks.map((link) => (
                 ...
                 {/* Dropdown Menu - Centered Mega Menu Style */}
                <AnimatePresence>
                    {isDropdownOpen && activeTab && navConfig[activeTab] && (
                        <motion.div
                            ref={dropdownRef}
                            ...
                            exit={{ opacity: 0, y: 5 }}
                            transition={{ duration: 0.2 }}
                            className="absolute top-full left-1/2 -translate-x-1/2 mt-1 origin-top z-50 pt-2"
          ...
          <div className="md:hidden ml-auto flex items-center gap-2">
            <button className="text-[#1c1c1c] dark:text-white">
